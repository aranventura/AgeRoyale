...
public class PartidaView extends JPanel {
    ...
    public PartidaView()
    {
        ...
        gridPanelCartas = new JPanel();
        panelOfensivas = new JPanel();
        panelDefensivas = new JPanel();
        panelElixirOfensivas = new JPanel();
        panelElixirDefensivas = new JPanel();
        textoDefOf = new JPanel();
    ...
    public void configureEast() {
        ...
        // Alineamientos.
        derechaNorthP.setAlignmentX(JPanel.RIGHT_ALIGNMENT);
        userMoney.setAlignmentX(JLabel.RIGHT_ALIGNMENT);
        imagenElixir.setAlignmentX(JLabel.RIGHT_ALIGNMENT);
        ...
        derechaNorthP.add(configButton);
    ...
    private void configureWest() {
        ...
        // Layouts.
        izquierdaCenterP.setLayout(new BoxLayout(izquierdaCenterP,BoxLayout.Y_AXIS));
        statusPanel.setLayout(new BoxLayout(statusPanel, BoxLayout.X_AXIS));
    ...
    private void configurarGridCartas() {
        ...
        arqueraE = getElixir(elixirImg.get(7));
        esqueletoE = getElixir(elixirImg.get(5));
        magoE = getElixir(elixirImg.get(4));
        cañonE = getElixir(elixirImg.get(7));
    ...
    /**
     * Método encargado de repintar la vista para nueva partida.
     */
    public void repintaPartida() {
        ...
        for (int i = 0; i < MAX_CELDAS; i++)
        {
            ...
            CeldaView square = (CeldaView) chessBoard.getComponent(i);
            square.setIconSquare(null);
            square.setOcupada(false);

            // Actualizar StatusBars
            actualizaStatusUser(100,  0, 10);
            actualizaStatusEnemy(100, 0);
            desSeleccionaCartas();

            // Resetear colores a las celdas.
            square.setBackground( i % 2 == 0 ? lightGreen : darkGreen );             // Seleccionamos el color de la celda en función de su posición.
            if(i < 7) {
                square.setBackground( i % 2 == 0 ? lightRed : darkRed );             // Color rojo base.
            }
