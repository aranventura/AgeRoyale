...
import PresentationLayoud.Controllers.CtrlReproducirPartida;
 ...
 */
public class PartidaRepetidaView extends JPanel {
    ...
    private void configurarGridCartas() {
        ...
        JButton card = getBotonFicha(arqueraImg, "");
        cardButtons.add(card);
        card = getBotonFicha(esqueletoImg, "");
        cardButtons.add(card);
        card = getBotonFicha(magoImg, "");
        cardButtons.add(card);
        card = getBotonFicha(cañonImg, "");
        cardButtons.add(card);
     ...
     */
    public void registerController(CtrlReproducirPartida controller) {
    ...
    public void addFicha(int iOrigen, int jOrigen, int ficha) {
